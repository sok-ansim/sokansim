  ...
  function showQuestion(index) {
    ...
    testScreen.innerHTML = `
      <div style="text-align:center; padding: 20px;">
        ...
        <button onclick="next(true)" style="margin: 10px; padding: 10px 20px; background-color: #100639; color: white; border: none; border-radius: 6px; font-size: 20px; cursor: pointer;">예</button>
        <button onclick="next(false)" style="margin: 10px; padding: 10px 20px; background-color: #100639; color: white; border: none; border-radius: 6px; font-size: 20px; cursor: pointer;">아니오</button>
      </div>
    `;
  }
  ...
  function showResult() {
    ...
    testScreen.innerHTML = `
      <div style="text-align:center; padding: 20px;">
        ...
        <a href="https://m.booking.naver.com/booking/13/bizes/400700?theme=place&lang=ko" target="_blank">
          <button style="margin: 10px; padding: 10px 20px; background-color: #100639; color: white; border: none; border-radius: 6px; font-size: 20px; cursor: pointer;">속안심내과 예약하기</button>
        </a>
      </div>
    `;
  }
